    ...
    options: [
        {
            ...
            options: [
                {
                    name: "duration",
                    description: "Podaj czas trwania konkursu! (1m ,1h, 1d)",
                    type: "STRING",
                    required: true,
                },
                {
                    name: "winner-count",
                    description: "Ile osób ma wygrać?",
                    type: "INTEGER",
                    required: true,
                },
                {
                    name: "prize",
                    description: "Co jest do wygrania?",
                    type: "STRING",
                    required: true,
                },
            ...
            case "start": {
                ...
                client.giveawaysManager.start(gChannel, {
                    ...
                    messages: {
                        ...
                        winMessage: '🎉 - Gratulację , {winners}! Twoja\'wygrana: **{this.prize}**!\n{this.messageURL}'
                    ...
                    sucEmbed.setDescription(`✅ - Konkurs został pomyślnie rozpoczęty w ${gChannel}`)
